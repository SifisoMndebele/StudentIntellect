package com.ssmnd.studentintellect.utils.pdfviewer.scroll
...
import com.ssmnd.studentintellect.utils.pdfviewer.PDFView
...
open class MyScrollHandle constructor(context: Context) : RelativeLayout(
    ...
    override fun hideDelayed() {
        myHandler.postDelayed(hidePageScrollerRunnable, 400)
    }
    ...
    companion object {
        ...
        private const val HANDLE_HEIGHT = 28
